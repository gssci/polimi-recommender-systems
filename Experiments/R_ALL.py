...
M = sparse.vstack([load_sparse_csr('CBF_tags1_ALLb.npz'),load_sparse_csr('CBF_tags2_ALLb.npz')])
time.sleep(5)
M *= 0.65
time.sleep(5)
M += 0.35*load_sparse_csr('CBF_title_ALLb.npz')
time.sleep(5)
M += 0.9*load_sparse_csr('ALS_ALL.npz')[indici_target]
time.sleep(5)
M += 0.3*load_sparse_csr('CF_ItemBased_GL_ALL.npz')[indici_target]
time.sleep(5)
M += 0.2*load_sparse_csr('SVD4k_ALL.npz')[indici_target]
time.sleep(5)
M += 0.1*load_sparse_csr('RJR_ALL.npz')
time.sleep(5)

N = 0.5 * load_sparse_csr('R_jobroles_ALL.npz')
N += 0.35 * load_sparse_csr('R_TopPop.npz')[indici_target]
N += 0.25 * load_sparse_csr('R_edu_fieldofstudies_ALL.npz')

# RTA = load_sparse_csr('CBF_tags_ALL.npz')[indici_target]
# RTI = load_sparse_csr('CBF_titles_ALL.npz')[indici_target]
#ALS = load_sparse_csr('ALS_ALL.npz')[indici_target]
#CF = load_sparse_csr('CF_ItemBased_GL_ALL.npz')[indici_target]
#RJR = load_sparse_csr('RJR_ALL.npz')
#TopPop = load_sparse_csr('R_TopPop.npz')[indici_target]

#R_CBFI = 0.65*RTA + 0.35*RTI
#IBRIDO = R_CBFI + 0.9*ALS + 0.3*CF + 0.1*RJR
